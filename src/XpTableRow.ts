...
export default class XpTableRow {
    ...
    _formattedXpGainedSoFar() : string {
        ...
        const valueToPad = typeof xpGainedSoFar === 'number' ? paddedXpGainedSoFar : xpGainedSoFar;
    ...
    _formattedXpNeededForNextLevel() : string {
        ...
        if (this.level.level === this.level.maxLevel) {
            ...
            valueToPad = typeof xpNeededForNextLevel === 'number' ? paddedXpNeeded : xpNeededForNextLevel;
        }
